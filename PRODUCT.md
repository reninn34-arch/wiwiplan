...
- Cada red se consulta en dos tramos por la misma razón: primero lo que se lee con los permisos que ya hay para publicar —me gusta y comentarios—, después lo que exige permiso de estadísticas —alcance, guardados, reproducciones—. Si el segundo falla, el primero sobrevive. En Instagram `views` sólo se pide cuando la pieza es un reel, porque pedirla en una foto hace fallar la llamada entera.
