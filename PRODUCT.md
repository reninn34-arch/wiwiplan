...
- `public/icons/og-2.png` (1200x630, opaca) es lo que ven WhatsApp, Facebook e iMessage, declarada en `openGraph`/`twitter` del layout. Sin declararla, cada app inventaba la vista previa y terminaba agarrando el icono cuadrado. Necesita `metadataBase`, porque quien lee el enlace está fuera y sólo entiende direcciones absolutas.
