...
- La URL de la imagen lleva `?v=`. WhatsApp y Facebook guardan la previsualización de cada enlace durante días: cambiar el archivo no basta, hay que darles una dirección que no conozcan. Ese número sube cuando cambia la tarjeta.
